...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3):
    ...
    # Calculate the new width and height of the bounding box, reduced by half
    half_width = int((c2[0] - c1[0]) / 4)
    half_height = int((c2[1] - c1[1]) / 4)

    # Adjust the bounding box coordinates to reduce size by half
    c1 = (c1[0] + half_width, c1[1] + half_height)
    c2 = (c2[0] - half_width, c2[1] - half_height)
